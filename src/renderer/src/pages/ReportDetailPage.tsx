  ...
  return (
    <div className="page">
      <nav className="nav-bar">
        <button className="nav-back" onClick={() => navigate('/reports/latest')} aria-label="뒤로">
      ...
      <div className="page-content">
        <div className="content-container" style={{ paddingTop: 16, paddingBottom: 24 }}>
          <div className="card" style={{ borderRadius: 16, overflow: 'hidden' }}>
            ...
            <div style={{ padding: 16, minHeight: 216 }}>
              {loading && (
